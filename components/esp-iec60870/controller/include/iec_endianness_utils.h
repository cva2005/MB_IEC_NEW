 ...
 */
int8_t iec_get_int8_a(val_16_arr *pi16);
 ...
 */
uint16_t iec_set_int8_a(val_16_arr *pi16, int8_t i8);
 ...
 *     - uint16_t value which represents the actual hex value of the register
 */
int8_t iec_get_int8_b(val_16_arr *pi16);
 ...
 *     - uint16_t value which represents the actual hex value of the register
 */
uint16_t iec_set_int8_b(val_16_arr *pi16, int8_t i8);
 ...
 */
uint8_t iec_get_uint8_a(val_16_arr *pu16);
 ...
 */
uint16_t iec_set_uint8_a(val_16_arr *pu16, uint8_t u8);
 ...
 *     - uint16_t the value which represents the actual hex value of the register
 */
uint8_t iec_get_uint8_b(val_16_arr *pu16);
 ...
 *     - uint16_t the value which represents the actual hex value of the register
 */
uint16_t iec_set_uint8_b(val_16_arr *pu16, uint8_t u8);
 ...
 */
int16_t iec_get_int16_ab(val_16_arr *pi16);
 ...
 *     - int16_t the value which represents the converted value from register
 */
uint16_t iec_set_int16_ab(val_16_arr *pi16, int16_t i16);
 ...
 */
uint16_t iec_get_uint16_ab(val_16_arr *pu16);
 ...
 */
uint16_t iec_set_uint16_ab(val_16_arr *pu16, uint16_t u16);
 ...
 */
int16_t iec_get_int16_ba(val_16_arr *pi16);
 ...
 *     - uint16_t value which represents the converted value from register
 */
uint16_t iec_set_int16_ba(val_16_arr *pi16, int16_t i16);
 ...
 *     - uint16_t value which represents the converted register value
 */
uint16_t iec_get_uint16_ba(val_16_arr *pu16);
 ...
 *     - uint16_t value which represents the converted value from register
 */
uint16_t iec_set_uint16_ba(val_16_arr *pu16, uint16_t u16);
 ...
 */
int32_t iec_get_int32_abcd(val_32_arr *pi32);
 ...
 */
uint32_t iec_set_int32_abcd(val_32_arr *pi32, int32_t i32);
 ...
 */
uint32_t iec_get_uint32_abcd(val_32_arr *pu32);
 ...
 *     - uint32_t value which represents the converted value from register
 */
uint32_t iec_set_uint32_abcd(val_32_arr *pu32, uint32_t u32);
 ...
 *     - int32_t value which represents the converted register value
 */
int32_t iec_get_int32_badc(val_32_arr *pi32);
 ...
 *     - uint32_t value which represents the converted value from register
 */
uint32_t iec_set_int32_badc(val_32_arr *pi32, int32_t i32);
 ...
 */
uint32_t iec_get_uint32_badc(val_32_arr *pu32);
 ...
 *     - uint32_t value which represents the converted value from register
 */
uint32_t iec_set_uint32_badc(val_32_arr *pu32, uint32_t u32);
 ...
 *     - int32_t value which represents the converted register value
 */
int32_t iec_get_int32_cdab(val_32_arr *pi32);
 ...
 *     - uint32_t value which represents the converted value from register
 */
uint32_t iec_set_int32_cdab(val_32_arr *pi32, int32_t i32);
 ...
 *     - int32_t value which represents the converted register value
 */
uint32_t iec_get_uint32_cdab(val_32_arr *pu32);
 ...
 *     - uint32_t value which represents the converted value from register
 */
uint32_t iec_set_uint32_cdab(val_32_arr *pu32, uint32_t u32);
 ...
 *     - int32_t value which represents the converted register value
 */
int32_t iec_get_int32_dcba(val_32_arr *pi32);
 ...
 *     - uint32_t value which represents the converted value from register
 */
uint32_t iec_set_int32_dcba(val_32_arr *pi32, int32_t i32);
 ...
 *     - uint32_t value which represents the converted register value
 */
uint32_t iec_get_uint32_dcba(val_32_arr *pu32);
 ...
 *     - uint32_t value which represents the converted value from register
 */
uint32_t iec_set_uint32_dcba(val_32_arr *pu32, uint32_t u32);
 ...
 */
float iec_get_float_abcd(val_32_arr *pf);
 ...
 *     - uint32_t value which represents the converted value from register
 */
uint32_t iec_set_float_abcd(val_32_arr *pf, float f);
 ...
 *     - float value which represents the converted register value
 */
float iec_get_float_badc(val_32_arr *pf);
 ...
 *     - uint32_t value which represents the converted value from register
 */
uint32_t iec_set_float_badc(val_32_arr *pf, float f);
 ...
 *     - float value which represents the converted register value
 */
float iec_get_float_cdab(val_32_arr *pf);
 ...
 *     - uint32_t value which represents the converted value from register
 */
uint32_t iec_set_float_cdab(val_32_arr *pf, float f);
 ...
 *     - float value which represents the converted register value
 */
float iec_get_float_dcba(val_32_arr *pf);
 ...
 *     - uint32_t value which represents the converted value from register
 */
uint32_t iec_set_float_dcba(val_32_arr *pf, float f);
 ...
 */
double iec_get_double_abcdefgh(val_64_arr *pd);
 ...
 */
uint64_t iec_set_double_abcdefgh(val_64_arr *pd, double d);
 ...
 *     - double value which represents the converted register value
 */
double iec_get_double_hgfedcba(val_64_arr *pd);
 ...
 *     - uint64_t value which represents the converted value from register
 */
uint64_t iec_set_double_hgfedcba(val_64_arr *pd, double d);
 ...
 *     - double value which represents the converted register value
 */
double iec_get_double_ghefcdab(val_64_arr *pd);
 ...
 *     - uint64_t value which represents the converted value from register
 */
uint64_t iec_set_double_ghefcdab(val_64_arr *pd, double d);
 ...
 *     - double value which represents the converted register value
 */
double iec_get_double_badcfehg(val_64_arr *pd);
 ...
 *     - uint64_t value which represents the converted value from register
 */
uint64_t iec_set_double_badcfehg(val_64_arr *pd, double d);
 ...
 */
int64_t iec_get_int64_abcdefgh(val_64_arr *pi64);
 ...
 *     - uint64_t value which represents the converted value from register
 */
uint64_t iec_set_int64_abcdefgh(val_64_arr *pi, int64_t i);
 ...
 *     - int64_t value which represents the converted register value
 */
int64_t iec_get_int64_ghefcdab(val_64_arr *pi64);
 ...
 *     - uint64_t value which represents the converted value from register
 */
uint64_t iec_set_int64_ghefcdab(val_64_arr *pi, int64_t i);
 ...
 *     - int64_t value which represents the converted register value
 */
int64_t iec_get_int64_hgfedcba(val_64_arr *pi64);
 ...
 *     - uint64_t value which represents the converted value from register
 */
uint64_t iec_set_int64_hgfedcba(val_64_arr *pi, int64_t i);
 ...
 *     - int64_t value which represents the converted register value
 */
int64_t iec_get_int64_badcfehg(val_64_arr *pi64);
 ...
 *     - uint64_t value which represents the converted value from register
 */
uint64_t iec_set_int64_badcfehg(val_64_arr *pi, int64_t i);
 ...
 */
uint64_t iec_get_uint64_abcdefgh(val_64_arr *pui);
 ...
 *     - uint64_t value which represents the converted value from register
 */
uint64_t iec_set_uint64_abcdefgh(val_64_arr *pui, uint64_t ui);
 ...
 *     - uint64_t value which represents the converted register value
 */
uint64_t iec_get_uint64_hgfedcba(val_64_arr *pui);
 ...
 *     - uint64_t value which represents the converted value from register
 */
uint64_t iec_set_uint64_hgfedcba(val_64_arr *pui, uint64_t ui);
 ...
 *     - uint64_t value which represents the converted register value
 */
uint64_t iec_get_uint64_ghefcdab(val_64_arr *pui);
 ...
 *     - uint64_t value which represents the converted value from register
 */
uint64_t iec_set_uint64_ghefcdab(val_64_arr *pui, uint64_t ui);
 ...
 *     - uint64_t value which represents the converted register value
 */
uint64_t iec_get_uint64_badcfehg(val_64_arr *pui);
 ...
 *     - uint64_t value which represents the converted value from register
 */
uint64_t iec_set_uint64_badcfehg(val_64_arr *pui, uint64_t ui);
