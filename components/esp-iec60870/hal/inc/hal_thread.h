...
#define Semaphore_create(x) xSemaphoreCreateBinary()
#define Semaphore_wait(self) { while (xSemaphoreTake(self, portMAX_DELAY) != pdTRUE); }
#define Semaphore_post(self) xSemaphoreGive(self)
#define Semaphore_destroy(self) vSemaphoreDelete(self)
